...
\usepackage[a4paper , left=15mm, top=20mm, right=15mm, bottom=32mm, footskip=5mm]{geometry}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=7cm]{decryption-public}
...
\section{\textbf{Other Wallet Features}}

\textbf{Custodian Services}\\

\textbf{Business-Wallet API and SDK}\\
...
\section{\textbf{Child Platforms}}

Intro about Child Platforms\\
