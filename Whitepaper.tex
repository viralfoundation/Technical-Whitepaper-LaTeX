...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={X-Technical Whitepaper}
}
...
\thepage\\
\vspace{0.3mm}
\footnotesize{\light{Xfoundation.org}}
\end{center}
}
\usepackage{babel}
\usepackage{authblk}
...
\title{\textbf{X - A Decentralized Regulated Multi-Tokenized Economy with Lightning Payments and Social Communication}}
...
Need for a universal bridge for connecting blockchains to governments for financial revolution\\
	...
	\subsection{Tendermint \& Cosmos SDK}

	\subsection{Masked Taxation for Regional Regulatory Benefits}

	\subsection{Lightning Payments}

	\subsection{Anchored Smart Contract Chains}

	\subsection{Transaction Fee using multiple Tokens}

	\subsection{Accredited Tokens Minting using Oracle Token Standard}

	\subsection{Verified and Registered Wallet Identities}

	\subsection{Prime Chain's Blocks and Validators}

	\subsection{Consensus, Staking and Delegation}

	\subsection{Block Rewards \& Token's Monetary Policy}
	
	\subsection{DLT Model of Chains}
...
\subsection{Lightning based nano-DEX}	
...
\subsection{\textbf{X Fiat-Exchange}}
...
\subsection{\textbf{X Payment Gateway - Web2 Integrations}}
