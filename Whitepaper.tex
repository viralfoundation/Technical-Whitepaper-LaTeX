...
\caption{Custodian Banks}
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[width=9cm]{minttagtokens}
\caption{Minting different fiats}
\end{center}
\end{figure}
...
graph TD
    ...
    D[Viral-FEX KYC User]

    H[Mints INR-Tag Token]
    I[Mints USD-Tag Toekn]
    J[Mints EUR-Tag Token]

    D--2.Deposits Indian Rupee-->B
    D--1.Deposits US Dollar-->A
    D--3.Deposits EURO-->C
    ...
    H & I & J --Transfers to Hot Wallet-->D
\begin{comment}

\textbf{Custodian Requirements}\\
...
While governing Viral Smart Chains protocols requires validators and nodes on voting consensus, the mobile application comprising de-fi protocols requires a decentralized autonomous organization (DAO) to vote on frequent updates and maintenance of offline compliances. \\
