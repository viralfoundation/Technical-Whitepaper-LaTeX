...
\begin{figure}
\begin{center}
\includegraphics[width=11cm]{stabletaxfig}
\caption{Inputs and Outputs of a Stable Purge-Tx}
\end{center}
\end{figure}
...
\textbf{Purged UTXOs inclusion}\\


\textbf{Debunking Transfer-Tax Evasion}\\
...
\subsection{Tax Registration Process}
