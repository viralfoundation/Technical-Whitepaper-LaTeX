...
\hline
\end{tabularx}
\caption{Example Swap Book matched order for $\sum_{BA=0}^{A} BA = \sum_{SA=0}^{A} SA$}
\end{center}
\end{figure}
...
\hline
\end{tabularx}
\caption{Example Swap Book matched order for $\sum_{BB=0}^{B} BB = \sum_{SB=0}^{B} SB$}
\end{center}
\end{figure}
\begin{equation}
