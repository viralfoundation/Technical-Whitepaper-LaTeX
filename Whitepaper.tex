...
\author[1]{Joby Reuben\thanks{A.A@university.edu}}
\author[1]{Ajay Joshua\thanks{B.B@university.edu}}
\author[1]{Naveen Jose\thanks{C.C@university.edu}}
\author[1]{Samarth Kulkarni\thanks{D.D@university.edu}}
\affil[1]{Viral Foundation, India}
...
Transfer Fee= $((500)-(500 \times  0.2\%)) \times  0.5\% = 0.2495$ \\
Final = $498.7505$\\

(Fee Type : Stable Pair) \\
Total Swap amount = $500$\\
DEX Fee : $500 \times  0.02\% = 0.1$ \\
Transfer Fee= $((500)-(500 \times  0.2\%)) \times  0.5\% = 0.24995$ \\
Final = $499.65005$\\
