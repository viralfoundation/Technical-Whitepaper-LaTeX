...
\hyperlink{https://youtu.be/-SiLnaSDkh4}{GunDB Explanatory Video}\\
...
\item \textbf{Crypto Back}: Similar to cashback systems in payment applications. Viral Pay users will receive cashback for every payment they make.
...
\begin{lstlisting}[language=Solidity, caption={User Reward Contract in Solidity}, numbers=none]
...
\subsection{ROV (Contribution-based) - 7.5\%}
...
\subsection{DAG-Miners (Transaction-based) - 6\%}
