...
\item VRL=20
\item VSC=45,000
\item Constant Product = 900,000 \footnote{$VRL*VSC = Constant Product$}
\item Market Price = 2,250
\end{itemize}

\textbf{Trade}: 9,000 VSC for VRL\\
\textbf{After Swap}:
\begin{itemize}[leftmargin=+0.2in]
\item VSC=54,000 
\item Constant Product = 900,000 (Stays Same)
\item VRL= 16.666  \footnote{$\frac{Constant Product}{New VSC}$}
\end{itemize}

\textbf{Results}:
\begin{itemize}[leftmargin=+0.2in]
\item Received VRL = 3.334 \footnote{${{Total VRL before trade}-{Total VRL after trade}}$}
\item Price paid per VRL = 2,699  \footnote{$\frac{Total VSC Provided}{Received VRL}$} 
\item \textbf{Price Impact} = \textbf{19.95\% }\footnote{$\frac{Market Price - Current Price}{Market Price}*100$}
\end{itemize}
