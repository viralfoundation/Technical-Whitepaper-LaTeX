...
Viral's IPFS cluster which is explained in the User Security and Privacy page of the whitewater, replicates data across trusted high efficiency IPFS nodes for a decentralized censorship resistant storage. Viral IPFS Clusters have the authority to remove data/files from it's nodes by fetching black-listed files fingerprints from ledger maintained through decentralized oracles - resistant to data tampering.\\

Visual Representation of Oracle and Clusters\\
...
\textbf{Pre-Moderation using AI Tools}

\textbf{Post-Moderation using AI Tools}
