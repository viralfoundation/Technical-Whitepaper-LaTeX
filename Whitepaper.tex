...
\author{Viral Foundation \\ viralfoundation.org}
...
\begin{equation}
Normal\:Pair\:Swap\:Fee=Swap\:Amount*0.2\%
\end{equation}
\begin{equation}
Stable\:Pair\:Swap\:Fee=Swap\:Amount*0.02\%
\end{equation}
\begin{equation}
Transfer\:Fee=After\:Swap\:Fee\:Rate*0.05%
\end{equation}\\
...
DEX Fee : $500*0.2\% = 1$ \\
Transfer Fee= $((500)-(500*0.2\%))*0.5\% = 0.2495$ \\
Final = $498.7505$\\

(Fee Type : Stable Pair) \\
Total Swap amount = $500$\\
DEX Fee : $500*0.02\% = 0.1$ \\
Transfer Fee= $((500)-(500*0.2\%))*0.5\% = 0.24995$ \\
Final = $499.65005$\\
...
\end{forest}
\caption{Types of Viral Application}
\end{center}
\end{figure}

Viral Release Applications are separated into two divisions that will have two methods of storing media in the decentralized way possible. Viral Beta-Developer Application resides Open-source as a repository for developers where it will be publicly accessible—anyone can see, modify, and distribute the code as they see fit. As it's open source Viral Alpha-Release 
