...
\usepackage[a4paper , left=28mm, top=30mm, right=28mm, bottom=40mm]{geometry}
...
Lack of new content\\
Tiktok \& Snapchat growth vs decentralized\\
...
\item \textbf{Originals} : \textbf{Physical assets} can be sold through Viral\textsc{\char13}s Original NFTs where people can buy and flex
...
\item \textbf{Filters} : Filters can be sold, and owned by user\textsc{\char13}s thereby get rewards for it
\end{enumerate}
\end{enumerate}

\subsection{Viral Avatars}
...
\subsection{Viral - User Security and Privacy}
...
All the user interests will be \textbf{stored locally} on the device to ensure \textbf{maximum security} and will be taken to show recommendations. Users\textsc{\char13} interests will be \textbf{saved locally} on their devices ensuring full privacy of personal data.\\
...
\subsection{Viral Token Ecosystem}
...
User Profits by Seigniorage\\
Pool User Deposit\\
Pool User Withdrawal\\
Need for Fiat Coins amidst Gold Stable Coin\\
Introduction to Fiat-Pegged Stable Coins\\
Shock Absorption via Viral Stable Coin\\
Minting Fiat Stable Tokens\\
Redeeming Viral Stable Coin (Gold)\\
Withdrawal and DEX Allocation from Volatility Pools\\
Stability of All Tokens Overview\\
Risks : In case of Fiat Inflation\\
Risks : For VRL Coin Holders, VSC and Fiat Holders\\
How VSC a hedge against Inflation\\
Conversion of VSC into Physical Gold through ETFs and Bullion\\
...
\subsubsection{Decentralized Block-chain Bridges}
...
\section{Viral Open-Source Distributions}
