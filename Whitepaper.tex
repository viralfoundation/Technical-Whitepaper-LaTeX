...
Moderation in current Social Platforms\\

Companies like Facebook, Twitter uses a combination of tools to search out and remove posts that violates their policies using AI and human moderators.\\

Issues faced by biased views, alogrithms, moderators, payrolls, slow,\\
