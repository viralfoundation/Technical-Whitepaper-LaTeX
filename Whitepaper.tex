...
The pools are represented in tables with rows mentioning number of pools where each pool will run on different blockchains and columns are represented to determine the cell value and percentage.\\
...
\begin{tabularx}{0.8\textwidth} { 
  ...
  | >{\centering\arraybackslash}X | }
 \hline
 \textbf{Cell} & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5}\\
 \hline
 \textbf{1}  & 100 & & & &  \\
  \hline
 \textbf{2} & 50  & 50 & & & \\
