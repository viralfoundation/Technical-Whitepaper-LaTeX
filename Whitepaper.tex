...
\textbf{Intro to Viral Semi-Centralized Exchange}\\
...
Fiat-Colored Tokens in Deposit Wallet\\
Atomic Exchange from token to token\\
Makers as Sellers\\
Makers as Buyers\\
Withdrawal of Fiat\\
Fiat-Colored Tokens when cross-region swaps\\
